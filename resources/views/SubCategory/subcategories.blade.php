                    ...
                    <table class="sa-datatables-init" data-order='[[ 1, "asc" ]]' data-sa-search-input="#table-search">
                        ...
                        @foreach($subCategories as $key=>$category)
                            ...
                            <tr>
                                ...
                                <td><a href="app-category.html" class="text-reset">{{ $category->subcategory_name  }}</a></td>
                                <td><a href="app-category.html" class="text-reset">{{ $category->category_name }}</a></td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="category-context-menu-0">
                                            <li><a class="dropdown-item" href="{{url('/admin/edit-sub_category/'.$category->subcategory_id)}}">Edit</a></li>

                                            <li><hr class="dropdown-divider" /></li>
                                            <li><a class="dropdown-item text-danger" href="{{url('/admin/delete-sub_category/'.$category->subcategory_id)}}">Delete</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
