                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <a href="app-product.html" class="text-reset">{{$product->name}}</a>
                                            <div class="sa-meta mt-0">
                                                <ul class="sa-meta__list">
                                                    <li class="sa-meta__item">
                                                        ID:
                                                        <span title="Click to copy product ID" class="st-copy">{{$product->product_id}}</span>
                                                    </li>
                                ...
                                <td><a href="app-category.html" class="text-reset">{{$product->category_name}}</a></td>
                                <td><div class="badge badge-sa-info">{{$product->status}}</div></td>
                                <td>
                                    <div class="sa-price">

                                        <span class="sa-price__integer">{{$product->brand_name}}</span>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="product-context-menu-0">
                                            <li><a class="dropdown-item" href="{{url('/admin/edit-products/'.$product->product_id)}}">Edit</a></li>
