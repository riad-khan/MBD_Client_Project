                            ...
                            <td>
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="category-context-menu-0">
                                        <li><a class="dropdown-item" href="{{url('/admin/edit-category/'.$category->category_id)}}">Edit</a></li>

                                        <li><hr class="dropdown-divider" /></li>
                                        <li><a class="dropdown-item text-danger" href="{{url('/admin/delete-category/'.$category->category_id)}}">Delete</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
